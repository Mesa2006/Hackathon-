...
* 
* Generated at 06/06/2026 08:56:19 UTC. Any changes will be lost.
* 
* Memory    Size                      Efficiency
* Buffers   122880 bytes (RAM)        93 %
* State     8424 bytes (RAM)          100 %
* Readonly  120 bytes (Flash)         100 %
* 
...
*    Parameter data_out is Output of size float[512,2,26].
...
// Working memory
static int8_t _buffer[122880];
static int8_t _state[8424];
...
#define _K12             ((int *)_k12)                       // s32[28] (112 bytes) 
#define _K6              ((float *)_k6)                      // f32[2] (8 bytes) 
#define _K10             ((float *)(_state + 0x000020dc))    // f32[3] (12 bytes) 
#define _K5              ((int8_t *)(_state + 0x00000000))   // s8[8400] (8400 bytes) 
#define _K9              ((int *)(_state + 0x000020d0))      // s32[3] (12 bytes) 
#define _K11             ((float *)(_buffer + 0x00000000))   // f32[2] (8 bytes) 
#define _K13             ((float *)(_buffer + 0x00004000))   // f32[512,2,26] (106496 bytes) 
#define _K3              ((float *)(_buffer + 0x00000000))   // f32[512,2] (4096 bytes) 
#define _K7              ((float *)(_buffer + 0x00001000))   // f32[512,2] (4096 bytes) 
#define _K8              ((float *)(_buffer + 0x00002000))   // f32[512,2,2] (8192 bytes) 
...
int IMAI_dequeue(float *restrict data_out, float *restrict time_out) {    
    __RETURN_ERROR(fixwin_dequeuef32(_K5, _K3, 128, time_out));
    hannmul_f32(_K3, _K6, _K7, 2, 512);
    rdft_ndim_f32(_K7, _K8, 1, 2, 512, _K9, _K10, _K11);
    mel_f32(_K8, _K12, 2, 1024, 26, _K13);
    power_to_db_f32(_K13, 26624, 0, 1E-10, 80, data_out);
    return 0;
}
